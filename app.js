...
const flowers = [
    { name: "Flowey", id: "sakura_1", icon: "flowers/sakura-1.png", description: "Поначалу Ffowey кажется дружелюбным и услужливым говорящим цветком, но вскоре оказывается, что он — садист с манией величия и более зловещими целями, 0,1% от общего количества Sakura Flower. ", link: "mode/1.html" },
    ...
    { name: "Dog Flower", id: "sakura_5", icon: "flowers/sakura-5.png", description: "Редкий штамм из зоны отчуждения Kyoto-Grid, устойчив к кислотным дождям.", link: "mode/5.html" },
    { name: "Wilted", id: "sakura_6", icon: "flowers/sakura-6.png", description: "Цифровой цветок, взломанный хакерами из Shibuya, шепчет код на ветру.", link: "mode/6.html" },
    { name: "Meower", id: "sakura_7", icon: "flowers/sakura-7.png", description: "Синтетическая сакура, созданная для украшения орбитальных станций.", link: "mode/7.html" },
