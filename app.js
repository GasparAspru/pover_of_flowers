...
const flowers = [
    { name: "Flowey", id: "sakura_1", icon: "flowers/sakura-1.png", description: "Поначалу Ffowey кажется дружелюбным и услужливым говорящим цветком, но вскоре оказывается, что он — садист с манией величия и более зловещими целями", link: "mode/1.html" },
